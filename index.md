...
<p><img src="images/CoESRA_desktops.png" class="icon-list" alt="CoESRA desktops" title="CoESRA desktops" /><a href="https://coesra.tern.org.au/#/tern-landingpage><strong>CoESRA:</strong></a><abbr title="Collaborative Environment for Scholarly Research and Analysis"><strong>CoESRA</strong></abbr></a><strong>:</strong> A configuarble online platform for data analysis. 
